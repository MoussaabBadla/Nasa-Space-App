                   ...
                   Padding(
                    padding: EdgeInsets.symmetric(vertical: 15),
                     child: Wrap(
                      ...
                      children: List.generate(bottunslist.length, (index) => SugChips(index: index, Sug: bottunslist,)) ,
                     ),
                   ), 
                   Container(
                    height: 350,
...
class SugChips extends StatelessWidget {
  const SugChips({
    ...
    super.key, required this.index, required this.Sug,
  });
  final int index  ; 
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Text(Sug[index],style: Theme.of(context).textTheme.bodySmall,),
        ),
      ),
    );
  }
